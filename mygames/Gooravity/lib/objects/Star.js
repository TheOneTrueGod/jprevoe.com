...
var Star = function (_Collectable) {
  _inherits(Star, _Collectable);

  function Star(position) {
    _classCallCheck(this, Star);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Star).call(this, position));

    _this._graphic = new PIXI.Sprite();
    _this._graphic.texture = Textures.starTexture;
  ...
  _createClass(Star, [{
    ...
    value: function getSize() {
      return Constants.STAR_SIZE + Constants.CHARACTER_SIZE / 2;
    }
  }, {
    key: "doTouchEffects",
    value: function doTouchEffects(world) {
      ...
      LevelState.addStar();
      Events.dispatch(Events.STAR_HIT);
    }
  }, {
    key: "clone",
